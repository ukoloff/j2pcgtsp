...
var $,X,H,W,Y,J=f((function(t,e){var n,o,i,r,s,a
...
return Math.sqrt(tt(t.x-e.x)+tt(t.y-e.y))}$=Q,X=k,H=J,W=K,Y=function(t,e){
var n,o,i,r,s,a
...
for(o in n=!1,i=H){r=i[o]
try{s=r.parser(e),a=r.parser.success(s),r.data=s,r.info=a,r.name=t.name,n=!0
break}catch(t){}}
n||W.badFiles.push(t.name),H.discrete.data&&H.route.data&&(W.routeLength=Y(H.route.data,H.discrete.data)),
X.redraw()}))}var it=function(){var t,e,n,o="",i=[],r={passive:!0}
...
},"this file")," (try: Right click + Save as) ","and run it locally"):void 0)))}
