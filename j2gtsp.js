...
else{var M,P,k=i,A=E-l+1,N=new Array(A),Z=0,T=0,D=2147483647,I=0
for(T=0;T<A;T++)N[T]=-1
for(T=E;T>=l;T--){null==M&&(M=w(e,h,y+1))
var O=M[(v=n[T]).key]
null!=O&&(D=O<D?O:-1,N[T-l]=O,d=e[O],e[O]=null,d!==v&&m(t,d,v,o,i,r),null!=v.dom&&(i=v.dom),
...
var T=D
function D(t){var e
return e=JSON.parse(t),A(e.length),e}D.success=function(t){var e,n
...
var $,X,W,H,Y,J=f((function(t,e){var n,o,i,r,s,a
...
return e}
Et=Q,Mt=gt
var zt,Pt,kt,At,Nt,Zt=function(t,e){var n,o,i,r,s,a,l,u
...
var Tt,Dt,It,Ot,Bt,Lt,jt=function(){Pt.mount(document.body,Nt)}
Nt={oncreate:function(t){zt(t.dom,{controlIconsEnabled:!0})},view:function(){
var t
return t=At.discrete.data.bounds,Pt.trust(kt.open(t)+"\n"+(At.dbs.data?wt(At.dbs.data):"")+"\n"+Ct(At.discrete.data)+"\n"+(At.route.data?Zt(At.route.data,At.discrete.data):"")+"\n"+kt.close())
}},Tt=k,Dt=nt,It=J,Ot=K,Bt=jt
var Rt,Vt,qt
Rt=k,Vt=N,qt={oncreate:function(t){var e
