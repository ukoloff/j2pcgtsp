...
else{var M,k,P=i,A=E-l+1,N=new Array(A),T=0,Z=0,D=2147483647,I=0
for(Z=0;Z<A;Z++)N[Z]=-1
for(Z=E;Z>=l;Z--){null==M&&(M=b(e,h,y+1))
var B=M[(v=n[Z]).key]
null!=B&&(D=B<D?B:-1,N[Z-l]=B,d=e[B],e[B]=null,d!==v&&m(t,d,v,o,i,r),null!=v.dom&&(i=v.dom),
I++)}if(i=P,I!==y-h+1&&C(t,e,h,y+1),0===I)u(t,n,l,E+1,o,i,r)
else if(-1===D)for(T=(k=function(t){var e=[0],n=0,o=0,i=0,r=w.length=t.length
...
for(;n-- >0;)e[n]=o,o=w[o]
return w.length=0,e
}(N)).length-1,Z=E;Z>=l;Z--)p=n[Z],-1===N[Z-l]?c(t,p,o,r,i):k[T]===Z-l?T--:S(t,p,i),
...
for(l=l<h?l:h;l<O;l++)(f=e[l])===(p=n[l])||null==f&&null==p||(null==f?c(t,p,o,r,x(e,l+1,i)):null==p?z(t,f):m(t,f,p,o,x(e,l+1,i),r))
...
e.children!==n.children?(k(t,e),f(t,n,o,i)):(n.dom=e.dom,
...
function c(){s(e,l),A(e),P(t,e)}}function k(t,e){
...
if("key"!==e&&"is"!==e&&null!=n&&!Z(e))if("o"!==e[0]||"n"!==e[1]||Z(e))if("style"===e)L(t.dom,n,null)
else if(!D(t,e,o)||"className"===e||"value"===e&&("option"===t.tag||"select"===t.tag&&-1===t.dom.selectedIndex&&t.dom===l())||"input"===t.tag&&"type"===e){
var i=e.indexOf(":")
...
return"-"===t[0]&&"-"===t[1]?t:"cssFloat"===t?"float":t.replace(I,B)}
...
z.parsePathname=E,z.buildPathname=w,z.vnode=e,z.PromisePolyfill=d
var k,P=z,A="svg {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100;\n  box-sizing: border-box;\n  padding: 0;\n}\n\npath {\n  stroke-width: 0.5%;\n  fill-rule: nonzero;\n}\n\npath.DBS {\n  fill: lime;\n  stroke: blue;\n}\n\npath.DBS:first-of-type {\n  fill: silver;\n}\n\npath.DBS:hover {\n  stroke-dasharray: 1%;\n  animation: dash 1s linear infinite;\n}\n\npath.part {\n  fill: white;\n  fill-opacity: 0%;\n  stroke: black;\n}\n\npath.part:hover {\n  fill: yellow;\n  fill-opacity: 50%;\n  stroke-dasharray: 1%;\n  animation: dash 1s linear infinite;\n}\n\npath.route {\n  stroke: red;\n  fill: none;\n}\n\ncircle.route {\n  r: 0.5%;\n  fill-opacity: 5%;\n  fill: red;\n  stroke: navy;\n  stroke-width: 0.3%;\n}\n\ncircle.route:hover {\n  fill-opacity: 75%;\n  stroke: lime;\n}\n\n@keyframes dash {\n  from {\n    stroke-dashoffset: 0%;\n  }\n  to {\n    stroke-dashoffset: -2%;\n  }\n}"
k=P
var N,T={view:function(){
return k.fragment(k("style","html, body {\n  margin: 0;\n  height: 100%;\n}\n\nh1 {\n  margin-block-start: 0;\n  text-align: center;\n}\n\nform {\n  padding: 1ex;\n}\n\ntable.formats {\n  border-collapse: collapse;\n}\n\n.hidden {\n  display: none;\n}\n\nh2 {\n  border-top: 1px dashed black;\n}"),k("style",A))
}},Z=function(t){if(!t)throw Error("Assertion failed!")}
N=Z
var D=I
function I(t){var e
return e=JSON.parse(t),N(e.length),e}I.success=function(t){var e,n
...
var B=function(t){var e,n,o,i,r
...
return a}
var L,j,R,V,q=[].slice,U=Array.from||function(t){return q.call(t)}
L=Z,j=B,R=O,V=function(t){return t.bounds={min:{
x:Math.min.apply(Math,[t.start.x].concat(U(t.points.map((function(t){return t.x
}))))),y:Math.min.apply(Math,[t.start.y].concat(U(t.points.map((function(t){
return t.y})))))},max:{
x:Math.max.apply(Math,[t.start.x].concat(U(t.points.map((function(t){return t.x
}))))),y:Math.max.apply(Math,[t.start.y].concat(U(t.points.map((function(t){
return t.y})))))}}}
var F=G
function G(t){var e,n
return function(t){L(t.TaskData),L(t.Contours)
}(e=JSON.parse(t)),n=j(e),R(n),V(n),n}G.success=function(t){
...
var $,X=f((function(t,e){var n,o,i,r,s,a
for(r in n=D,o=F,i=_,e.dbs=n,e.discrete=o,e.route=i,s=e)a=s[r],e[r]={parser:a}
})),W=(X.dbs,X.discrete,X.route,{routeLength:0,badFiles:[]})
$=X
var Y,J,K,Q,tt=function(t,e){var n
...
function et(t){return t*t}function nt(t,e){
return Math.sqrt(et(t.x-e.x)+et(t.y-e.y))}Y=tt,J=X,K=W,Q=function(t,e){
var n,o,i,r,s,a
n=Y.apply(this,arguments),o=0,n.length&&(i=n[n.length-1])
for(r=0,s=n.length;r<s;++r)a=n[r],o+=nt(i,a),i=a
return o}
var ot,it,rt,st,at=function(){
J.discrete.data&&J.route.data&&(K.routeLength=Q(J.route.data,J.discrete.data))}
ot=P,it=X,rt=W,st=at
var lt=function(t){var e,n
for(rt.badFiles.length=0,e=0,n=t.length;e<n;++e)ut(t[e])}
function ut(t){t.text().then((function(e){var n,o,i,r,s,a
for(o in n=!1,i=it){r=i[o]
try{s=r.parser(e),a=r.parser.success(s),r.data=s,r.info=a,r.name=t.name,n=!0
break}catch(t){}}n||rt.badFiles.push(t.name),st(),ot.redraw()}))}
var ct=function(){var t,e,n,o="",i=[],r={passive:!0}
...
off:function(t,e,o){
a(t,n,e,o),"DOMMouseScroll"==n&&a(t,"MozMousePixelScroll",e,o)}}}(),ht={
extend:function(t,e){
...
return"auto"!==t&&t<60&&t>1&&(e=Math.floor(1e3/t)),null===e?window.requestAnimationFrame||ft(33):ft(e)
}}
function ft(t){return function(e){window.setTimeout(e,t)}}var pt="unknown"
document.documentMode&&(pt="ie")
var dt={svgNS:"http://www.w3.org/2000/svg",
...
if(!(n=ht.isElement(e)?e:t.querySelector(e))){
...
refreshDefsGlobal:ht.throttle((function(){
...
"ie"===pt&&n&&(n.parentNode.insertBefore(n,n),window.setTimeout((function(){
o.refreshDefsGlobal()}),o.internetExplorerRedisplayInterval))},
getEventPoint:function(t,e){var n=e.createSVGPoint()
return ht.mouseAndTouchNormalize(t,e),n.x=t.clientX,n.y=t.clientY,n},
...
return o.x=e,o.y=n,o}},vt={enable:function(t){var e=t.svg.querySelector("defs")
if(e||(e=document.createElementNS(dt.svgNS,"defs"),t.svg.appendChild(e)),!e.querySelector("style#svg-pan-zoom-controls-styles")){
var n=document.createElementNS(dt.svgNS,"style")
...
e.appendChild(n)}var o=document.createElementNS(dt.svgNS,"g")
...
var e=document.createElementNS(dt.svgNS,"g")
...
var n=document.createElementNS(dt.svgNS,"rect")
...
var o=document.createElementNS(dt.svgNS,"path")
...
_createZoomReset:function(t){var e=document.createElementNS(dt.svgNS,"g")
...
var i=document.createElementNS(dt.svgNS,"path")
...
_createZoomOut:function(t){var e=document.createElementNS(dt.svgNS,"g")
...
t.controlIcons=null)}},mt=function(t,e){this.init(t,e)}
mt.prototype.init=function(t,e){
this.viewport=t,this.options=e,this.originalState={zoom:1,x:0,y:0
},this.activeState={zoom:1,x:0,y:0
},this.updateCTMCached=ht.proxy(this.updateCTM,this),
this.requestAnimationFrame=ht.createRequestAnimationFrame(this.options.refreshRate),
this.viewBox={x:0,y:0,width:0,height:0},this.cacheViewBox()
var n=this.processCTM()
this.setCTM(n),this.updateCTM()},mt.prototype.cacheViewBox=function(){
...
}else this.simpleViewBoxCache()},mt.prototype.simpleViewBoxCache=function(){
var t=this.viewport.getBBox()
this.viewBox.x=t.x,this.viewBox.y=t.y,this.viewBox.width=t.width,this.viewBox.height=t.height
},mt.prototype.getViewBox=function(){return ht.extend({},this.viewBox)
},mt.prototype.processCTM=function(){var t,e=this.getCTM()
...
e},mt.prototype.getOriginalState=function(){
return ht.extend({},this.originalState)},mt.prototype.getState=function(){
return ht.extend({},this.activeState)},mt.prototype.getZoom=function(){
return this.activeState.zoom},mt.prototype.getRelativeZoom=function(){
return this.activeState.zoom/this.originalState.zoom
},mt.prototype.computeRelativeZoom=function(t){return t/this.originalState.zoom
},mt.prototype.getPan=function(){return{x:this.activeState.x,
y:this.activeState.y}},mt.prototype.getCTM=function(){
...
t.f=this.activeState.y,t},mt.prototype.setCTM=function(t){
...
!1===o?(t.e=this.getPan().x,t.f=this.getPan().y,i=r=!0):ht.isObject(o)&&(!1===o.x?(t.e=this.getPan().x,
i=!0):ht.isNumber(o.x)&&(t.e=o.x),
!1===o.y?(t.f=this.getPan().y,r=!0):ht.isNumber(o.y)&&(t.f=o.y)),
i&&r||!this.isPanDifferent(t)?n=!1:(this.updateCache(t),
this.options.onPan(this.getPan()))}(e||n)&&this.updateCTMOnNextFrame()}
},mt.prototype.isZoomDifferent=function(t){return this.activeState.zoom!==t.a
},mt.prototype.isPanDifferent=function(t){
return this.activeState.x!==t.e||this.activeState.y!==t.f
},mt.prototype.updateCache=function(t){
this.activeState.zoom=t.a,this.activeState.x=t.e,this.activeState.y=t.f
},mt.prototype.pendingUpdate=!1,mt.prototype.updateCTMOnNextFrame=function(){
this.pendingUpdate||(this.pendingUpdate=!0,
this.requestAnimationFrame.call(window,this.updateCTMCached))
},mt.prototype.updateCTM=function(){var t=this.getCTM()
dt.setCTM(this.viewport,t,this.defs),this.pendingUpdate=!1,this.options.onUpdatedCTM&&this.options.onUpdatedCTM(t)
}
var gt=function(t,e){this.init(t,e)},yt={
...
onUpdatedCTM:null},bt={passive:!0}
gt.prototype.init=function(t,e){var n=this
this.svg=t,this.defs=t.querySelector("defs"),dt.setupSvgAttributes(this.svg),this.options=ht.extend(ht.extend({},yt),e),
this.state="none"
var o=dt.getBoundingClientRectNormalized(t)
this.width=o.width,this.height=o.height,this.viewport=function(t,e){
return new mt(t,e)
}(dt.getOrCreateViewport(this.svg,this.options.viewportSelector),{svg:this.svg,
...
i.setOnUpdatedCTM(this.options.onUpdatedCTM),this.options.controlIconsEnabled&&vt.enable(this),
this.lastMouseWheelEventTime=Date.now(),this.setupHandlers()
},gt.prototype.setupHandlers=function(){var t=this,e=null
...
for(var i in this.eventListeners)(this.options.eventsListenerElement||this.svg).addEventListener(i,this.eventListeners[i],!this.options.preventMouseEventsDefault&&bt)
this.options.mouseWheelZoomEnabled&&(this.options.mouseWheelZoomEnabled=!1,this.enableMouseWheelZoom())
},gt.prototype.enableMouseWheelZoom=function(){
...
ct.on(this.options.eventsListenerElement||this.svg,this.wheelListener,e),this.options.mouseWheelZoomEnabled=!0
}},gt.prototype.disableMouseWheelZoom=function(){
if(this.options.mouseWheelZoomEnabled){
var t=!this.options.preventMouseEventsDefault
ct.off(this.options.eventsListenerElement||this.svg,this.wheelListener,t),this.options.mouseWheelZoomEnabled=!1
}},gt.prototype.handleMouseWheel=function(t){
...
var i=this.svg.getScreenCTM().inverse(),r=dt.getEventPoint(t,this.svg).matrixTransform(i),s=Math.pow(1+this.options.zoomScaleSensitivity,-1*e)
this.zoomAtPoint(s,r)}},gt.prototype.zoomAtPoint=function(t,e,n){
...
a.a!==i.a&&this.viewport.setCTM(a)},gt.prototype.zoom=function(t,e){
this.zoomAtPoint(t,dt.getSvgCenterPoint(this.svg,this.width,this.height),e)
},gt.prototype.publicZoom=function(t,e){
e&&(t=this.computeFromRelativeZoom(t)),this.zoom(t,e)
},gt.prototype.publicZoomAtPoint=function(t,e,n){
if(n&&(t=this.computeFromRelativeZoom(t)),"SVGPoint"!==ht.getType(e)){
if(!("x"in e)||!("y"in e))throw new Error("Given point is invalid")
e=dt.createSVGPoint(this.svg,e.x,e.y)}this.zoomAtPoint(t,e,n)
},gt.prototype.getZoom=function(){return this.viewport.getZoom()
},gt.prototype.getRelativeZoom=function(){return this.viewport.getRelativeZoom()
},gt.prototype.computeFromRelativeZoom=function(t){
return t*this.viewport.getOriginalState().zoom
},gt.prototype.resetZoom=function(){var t=this.viewport.getOriginalState()
this.zoom(t.zoom,!0)},gt.prototype.resetPan=function(){
this.pan(this.viewport.getOriginalState())},gt.prototype.reset=function(){
this.resetZoom(),this.resetPan()},gt.prototype.handleDblClick=function(t){var e
...
var n=dt.getEventPoint(t,this.svg).matrixTransform(this.svg.getScreenCTM().inverse())
this.zoomAtPoint(e,n)},gt.prototype.handleMouseDown=function(t,e){
this.options.preventMouseEventsDefault&&(t.preventDefault?t.preventDefault():t.returnValue=!1),
ht.mouseAndTouchNormalize(t,this.svg),
this.options.dblClickZoomEnabled&&ht.isDblClick(t,e)?this.handleDblClick(t):(this.state="pan",
this.firstEventCTM=this.viewport.getCTM(),
this.stateOrigin=dt.getEventPoint(t,this.svg).matrixTransform(this.firstEventCTM.inverse()))
},gt.prototype.handleMouseMove=function(t){
if(this.options.preventMouseEventsDefault&&(t.preventDefault?t.preventDefault():t.returnValue=!1),
"pan"===this.state&&this.options.panEnabled){
var e=dt.getEventPoint(t,this.svg).matrixTransform(this.firstEventCTM.inverse()),n=this.firstEventCTM.translate(e.x-this.stateOrigin.x,e.y-this.stateOrigin.y)
this.viewport.setCTM(n)}},gt.prototype.handleMouseUp=function(t){
this.options.preventMouseEventsDefault&&(t.preventDefault?t.preventDefault():t.returnValue=!1),
"pan"===this.state&&(this.state="none")},gt.prototype.fit=function(){
var t=this.viewport.getViewBox(),e=Math.min(this.width/t.width,this.height/t.height)
this.zoom(e,!0)},gt.prototype.contain=function(){
var t=this.viewport.getViewBox(),e=Math.max(this.width/t.width,this.height/t.height)
this.zoom(e,!0)},gt.prototype.center=function(){
var t=this.viewport.getViewBox(),e=.5*(this.width-(t.width+2*t.x)*this.getZoom()),n=.5*(this.height-(t.height+2*t.y)*this.getZoom())
this.getPublicInstance().pan({x:e,y:n})},gt.prototype.updateBBox=function(){
this.viewport.simpleViewBoxCache()},gt.prototype.pan=function(t){
var e=this.viewport.getCTM()
e.e=t.x,e.f=t.y,this.viewport.setCTM(e)},gt.prototype.panBy=function(t){
var e=this.viewport.getCTM()
e.e+=t.x,e.f+=t.y,this.viewport.setCTM(e)},gt.prototype.getPan=function(){
var t=this.viewport.getState()
return{x:t.x,y:t.y}},gt.prototype.resize=function(){
var t=dt.getBoundingClientRectNormalized(this.svg)
...
this.getPublicInstance().enableControlIcons())},gt.prototype.destroy=function(){
var t=this
...
instance:this.getPublicInstance()
}),this.eventListeners)(this.options.eventsListenerElement||this.svg).removeEventListener(e,this.eventListeners[e],!this.options.preventMouseEventsDefault&&bt)
this.disableMouseWheelZoom(),this.getPublicInstance().disableControlIcons(),this.reset(),
xt=xt.filter((function(e){return e.svg!==t.svg
})),delete this.options,delete this.viewport,
delete this.publicInstance,delete this.pi,this.getPublicInstance=function(){
return null}},gt.prototype.getPublicInstance=function(){var t=this
...
return t.options.beforePan=null===e?null:ht.proxy(e,t.publicInstance),t.pi},
setOnPan:function(e){
return t.options.onPan=null===e?null:ht.proxy(e,t.publicInstance),t.pi},
...
vt.enable(t)),t.pi},disableControlIcons:function(){
return t.options.controlIconsEnabled&&(t.options.controlIconsEnabled=!1,
vt.disable(t)),t.pi},isControlIconsEnabled:function(){
...
return t.options.beforeZoom=null===e?null:ht.proxy(e,t.publicInstance),t.pi},
setOnZoom:function(e){
return t.options.onZoom=null===e?null:ht.proxy(e,t.publicInstance),t.pi},
...
return t.options.onUpdatedCTM=null===e?null:ht.proxy(e,t.publicInstance),t.pi},
...
return e+" Z"}
var St,Et=function(t,e){var n,o,i
null==e&&(e={}),"string"!=typeof t&&(t=wt(t))
for(o in n="",e)i=e[o],n+=" "+o+'="'+i+'"'
return"<path"+n+' d="'+t+'">\n'+(e.title?"<title>"+e.title+"</title>":"")+"</path>"
}
St=Et
var Mt,Ct=function(t){return t.map(zt).join("")}
function zt(t){return St(t.paths.map(kt).join(""),{class:"DBS",
...
e}function Pt(t){return t*t}Mt=Et
var At,Nt,Tt=function(t){var e,n,o,i,r
for(e="",n=0,i=(o=t.groups).length;n<i;++n)r=o[n],e+="\n"+Mt(r.points,{
class:"part",title:"Group #"+r.id+"\nPoints: "+r.points.length})
return e}
At=tt,Nt=Et
var Zt,Dt,It=function(t,e){var n,o,i,r,s,a,l,u
for(n=At.apply(this,arguments),o=Nt(n,{class:"route"
...
var Bt,Ot,Lt,jt,Rt=function(){var t
return t=Dt.discrete.data.bounds,Zt.open(t)+"\n"+(Dt.dbs.data?Ct(Dt.dbs.data):"")+"\n"+Tt(Dt.discrete.data)+"\n"+(Dt.route.data?It(Dt.route.data,Dt.discrete.data):"")+"\n"+Zt.close()
}
Bt=function(t,e){var n=ht.getSvg(t)
if(null===n)return null
for(var o=xt.length-1;o>=0;o--)if(xt[o].svg===n)return xt[o].instance.getPublicInstance()
return xt.push({svg:n,instance:new gt(n,e)
}),xt[xt.length-1].instance.getPublicInstance()},Ot=P,Lt=Rt
var Vt=function(){
Ot.mount(document.body,jt),history.pushState({},"View SVG"),window.onpopstate=qt
}
function qt(){var t
t=ee,window.onpopstate=void 0,Ot.mount(document.body,t)}jt={
oncreate:function(t){Bt(t.dom,{controlIconsEnabled:!0})},view:function(){
return Ot.trust(Lt())}}
var Ut,Ft,Gt,_t,Ht,$t,Xt,Wt,Yt,Jt
Ut=X,Ft=Rt,Gt=P,_t=lt,Ht=X,$t=W,Xt=Vt,Wt=function(){
t=Ut.discrete.name+".html",e="<!DOCTYPE html>\n<html><head>\n<title>"+document.title+"</title>\n<style>\nsvg {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100;\n  box-sizing: border-box;\n  padding: 0;\n}\n\npath {\n  stroke-width: 0.5%;\n  fill-rule: nonzero;\n}\n\npath.DBS {\n  fill: lime;\n  stroke: blue;\n}\n\npath.DBS:first-of-type {\n  fill: silver;\n}\n\npath.DBS:hover {\n  stroke-dasharray: 1%;\n  animation: dash 1s linear infinite;\n}\n\npath.part {\n  fill: white;\n  fill-opacity: 0%;\n  stroke: black;\n}\n\npath.part:hover {\n  fill: yellow;\n  fill-opacity: 50%;\n  stroke-dasharray: 1%;\n  animation: dash 1s linear infinite;\n}\n\npath.route {\n  stroke: red;\n  fill: none;\n}\n\ncircle.route {\n  r: 0.5%;\n  fill-opacity: 5%;\n  fill: red;\n  stroke: navy;\n  stroke-width: 0.3%;\n}\n\ncircle.route:hover {\n  fill-opacity: 75%;\n  stroke: lime;\n}\n\n@keyframes dash {\n  from {\n    stroke-dashoffset: 0%;\n  }\n  to {\n    stroke-dashoffset: -2%;\n  }\n}\n</style>\n<script src=\"http://bumbu.github.io/svg-pan-zoom/dist/svg-pan-zoom.min.js\"><\/script>\n<script>\n  setTimeout(initPan)\n  function initPan() {\n    var svg = document.getElementsByTagName('svg')[0]\n    svgPanZoom(svg, {controlIconsEnabled: true})\n  }\n<\/script>\n</head><body>\n"+Ft()+"\n</body></html>",
...
var t,e,n,o},Yt=at
var Kt,Qt,te,ee={oncreate:function(t){var e
...
return _t(t.dataTransfer.files),!1}},onremove:function(t){var e
;(e=t.dom.parentNode).ondragenter=null,
e.ondragleave=null,e.ondragover=null,e.ondrop=null},view:function(){var t,e
return Gt.fragment(Gt("h1",document.title="View DBS / JSON / GTSP"),Gt("form",Gt("table.formats[border]",Gt("tr",Gt("th","Data"),Gt("th",".ext"),Gt("th",Gt("nobr","File name")),Gt("th[width=100%]","Additional info")),Gt("tr",Gt("td","DBS"),Gt("td",".dbs.json"),Gt("td",Gt("b",Gt("nobr",Ht.dbs.name))),Gt("td",Ht.dbs.info)),Gt("tr",Gt("td","GTSP"),Gt("td",".json"),Gt("td",Gt("b",Gt("nobr",Ht.discrete.name))),Gt("td",Ht.discrete.info)),Gt("tr",Gt("td","Route"),Gt("td",".result.txt"),Gt("td",Gt("b",Gt("nobr",Ht.route.name))),Gt("td",Ht.route.info))),Gt("p"),Gt("label","Starting point: ",Gt("select",{
oncreate:function(t){try{
return t.dom.selectedIndex=Ht.route.startPointMode=localStorage["starting-pont"]||0
}catch(t){}},onchange:function(){try{
return localStorage["starting-pont"]=Ht.route.startPointMode=this.selectedIndex,
Yt()}catch(t){}}},function(){var e,n,o,i=[]
for(e=0,o=(n="Autodetect;First contour (new format);Last contour (old format)".split(";")).length;e<o;++e)t=n[e],
i.push(Gt("option",t))
return i}())),Gt("p"),Gt("input.hidden",{type:"file",multiple:!0,
oncreate:function(t){(Jt=t.dom).onchange=function(){_t(this.files)}}
}),Gt("button",{type:"button",onclick:function(){Jt.click()}
},"Upload file(s)")," ...or drag-and-drop file(s) onto this page...",$t.badFiles.length?Gt("p","Unknown files: "+$t.badFiles.join(", ")):void 0,Gt("hr"),(e=$t.routeLength)?Gt("p","Route length: "+e):void 0,Gt("button",{
type:"button",disabled:!Ht.discrete.data,onclick:Xt
},"View!")," in View mode hit Back or Refresh (F5) to come back to this page",Gt("p"),Gt("button",{
type:"button",disabled:!Ht.discrete.data,onclick:Wt
},"Export HTML + SVG"),Gt("h2","Note:"),Gt("ul",Gt("li",Gt("a",{
href:"https://github.com/ukoloff/j2pcgtsp"
},"Source code"),"@GitHub"),location.host?Gt("li","You can save ",Gt("a",{
href:"j2gtsp.html",target:"_blank",download:"j2gtsp.html",
type:"application/octet-stream"
},"this file")," (Hint: Right click + Save as) ","and run it locally"):void 0)))
}}
Kt=P,Qt=T,te=ee,setTimeout((function(){
Kt.mount(document.head,Qt),Kt.mount(document.body,te)}))}()
